// Copyright (c) 2016-2017 The brsuite developers
...
filters in Brocoin. The usage is intended to be the inverse of Bloom filters:
...
probability for Brocoin use is 2^-20.
*/
package gcs
