...
/*
This test file is part of the bronutil package rather than than the
bronutil_test package so it can bridge access to the internals to properly test
...
func TstAddressPubKey(serializedPubKey []byte, pubKeyFormat PubKeyFormat,
	...
	pubKey, _ := bronec.ParsePubKey(serializedPubKey, bronec.S256())
	return &AddressPubKey{
		pubKeyFormat: pubKeyFormat,
		pubKey:       (*bronec.PublicKey)(pubKey),
		pubKeyHashID: netID,
	}
}

// TstAddressSAddr returns the expected script address bytes for
// P2PKH and P2SH brocoin addresses.
...
// bech32 encoded P2WPKH and P2WSH brocoin addresses.
