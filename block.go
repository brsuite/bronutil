// Copyright (c) 2013-2016 The brsuite developers
...
// Block defines a brocoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (bronutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (bronutil.Tx) for all
...
// instead provides easy access to wrapped versions (bronutil.Tx) of them.
...
// NewBlock returns a new instance of a brocoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a brocoin block given the
...
// NewBlockFromReader returns a new instance of a brocoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a brocoin block given
