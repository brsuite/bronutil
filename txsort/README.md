...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brsuite/bronutil/txsort)

Package txsort provides the transaction sorting according to [BIP 69](https://github.com/brocoin/bips/blob/master/bip-0069.mediawiki).
...
```bash
$ go get -u github.com/brsuite/bronutil/txsort
```
