...
func TestMerkleBlock3(t *testing.T) {
	...
	blk, err := bronutil.NewBlockFromBytes(blockBytes)
	if err != nil {
	...
	err = mBlock.BRONEncode(got, wire.ProtocolVersion, wire.LatestEncoding)
	if err != nil {
		t.Errorf("TestMerkleBlock3 BRONEncode failed: %v", err)
		return
	}
