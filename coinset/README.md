...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brsuite/bronutil/coinset)

Package coinset provides brocoin-specific convenience functions for selecting
...
```bash
$ go get -u github.com/brsuite/bronutil/coinset
```
...
The typical use case for this library is for creating raw brocoin transactions
