...
import (
	...
	"github.com/brsuite/bronutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    bronutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash  { return c.TxHash }
func (c *TestCoin) Index() uint32          { return c.TxIndex }
func (c *TestCoin) Value() bronutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value bronutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035BRON value.
	...
	testSimpleCoinTxValue0            = bronutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = bronutil.NewTxFromBytes(testSimpleCoinTxBytes)
